...
const {
  ...
  sortBy,
  setFilter,
} = usePagination(["data-smote"], "/data-smote");
...
<template>
  <Parent>
    <BreadCrumb title="Data SMOTE" subtitle="Administrator" />
    <div class="alert alert-info">
      Data SMOTE adalah data yang sudah diolah dengan teknik SMOTE untuk mengatasi masalah ketidakseimbangan kelas pada dataset.
    </div>
    <DataTable
      :data="data"
      :setSearch="setSearch"
